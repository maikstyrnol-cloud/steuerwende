...
def build_static_pages(out):
  ...
  <main class="article-page">
    ...
    <div class="article-body container">
      ...
      <p>SteuerWende ist ein unabhängiges, nicht-kommerzielles Informationsangebot ohne Werbung.</p>
      <h2>Haftung für Inhalte</h2>
      <p>Als Diensteanbieter sind wir gemäß § 7 Abs. 1 TMG für eigene Inhalte verantwortlich.</p>
      <h2>Urheberrecht</h2>
      <p>Downloads sind nur für den privaten, nicht kommerziellen Gebrauch gestattet.</p>
    </div>
  </main>"""
